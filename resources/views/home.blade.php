    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                ...
                <br><br><h1>Status Of Jobs - Real Time Monitor</h1><br>
                <div class="mt-12 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <table class="table table-bordered table-dark">
                        <thead>
                            ...
                            <th scope="col">Processed jobs</th>                            
                        ...
                        <tbody>
                            ...
                            <td>{{ $batch->totalJobs - $batch->pendingJobs }}</td>
                ...
                <br><br><h1>Log File Content</h1><br>
                <div class="mt-12 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="form-group shadow-textarea">
                        <ul class="nav nav-pills nav-stacked anyClass">
                            @foreach ($logs as $log)
                                <li class="nav-item">
                                    <p><b>&nbsp&nbsp&nbspBatch ID:</b> {{ $log->batchId }}&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp<b>Log:</b> {{ $log->log }}&nbsp&nbsp&nbsp|&nbsp&nbsp<b>Help:</b> {{ $log->help }} </p>
                                </li>
                            @endforeach
